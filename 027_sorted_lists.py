"""Q Write a function that takes in two sorted lists and outputs a sorted list that is their union"""

#Solution 1 (Simple Pythonic)
...
list_a = [1,3,5]
list_b = [2,4,6]
print(return_union(list_a, list_b))
