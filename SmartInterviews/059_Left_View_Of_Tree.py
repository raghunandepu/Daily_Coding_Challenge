# https://www.hackerrank.com/contests/smart-interviews/challenges/si-left-view-of-tree/problem
...
2. Print first element only in each level"""
...
def levelOrder(root):
    ...
    while len(queue) > 0:
        ...
        for i in range(l):
            ...
            # print first element in level order traversal
            if i == 0:
                print (node.info, end =" ")
